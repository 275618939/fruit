...
$(function(){
	...
	$("#contentCard .cartInfo").toggle(function(){
		$("#cartPopover").show();
		$("#contentCard .cartInfo").addClass('open');
	}, function(){
		$("#cartPopover").hide();
		$("#contentCard .cartInfo").removeClass('open');
	});
	
	
	$("#e .simpleCart_shelfItem:eq(0)").css('left', '310px');
	$("#e .simpleCart_shelfItem:eq(1)").css('left', '171px');
	$("#e .simpleCart_shelfItem:eq(2)").css('left', '29px');
	$("#e .simpleCart_shelfItem").delay(500).animateStep({css:{top:'0px'},delay:100,speed:100});
	$("#e .simpleCart_shelfItem").click(function(){
	...
	*******************************/
	...
	$("#gatewayDemoList").click(function(){
